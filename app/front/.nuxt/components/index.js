...
export { default as TweetButton } from '../../components/TweetButton.vue'
...
export const LazyTweetButton = import('../../components/TweetButton.vue' /* webpackChunkName: "components/tweet-button" */).then(c => c.default || c)
